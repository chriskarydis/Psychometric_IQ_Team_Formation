...
class App:
    def __init__(self, master):
        self.questions = {
            1: {
                "text": "Τι αντιπροσωπεύει τον χώρο εργασίας όπου κάνετε τη δουλειά σας καλύτερα?",
                "options": {
            ...
            4: {
                ...
                "options": {
                    ...
                    3:"Δεν με ενθουσιάζουν αλλά οταν μπω μέσα το απολαμβάνω.",
                    4:"Τις αγαπώ, ειναι πολύ σημαντικές για την ομάδα."
                },
                "score": 0,
                "score1": 3     
            },
            5: {
                "text": "Ποια λένε για εσένα, οι συνάδελφοι σου, ότι είναι η μεγαλύτερη δύναμη σου;",
                "options": {
                    1:"Να λύνω δύσκολα προβλήματα.",
                    2:"Να έρχομαι με καλές ιδεές.",
                    3:"Να μπορώ να πείσω τους άλλους να υποστηρίξουν την ομάδα.",
                    4:"Να βάζω την ομάδα σε σωστό δρόμο και να την καθοδηγώ."
                },
                "score": 0,
                "score1": 4     
            },
            6: {
                ...
                "options": {
                    ...
                    3:"Άτομα που τρέχουν πολύ μπροστάσ στην δουλεία χωρίς να την έχουν καταλάβει.",
            ...
            7: {
                ...
                "options": {
                    1:"Είναι απίθανο νσ κάνω φασαρία.",
            ...
            9: {
                "text": "Τι σε παθίαζει περισσότερος;",
                "options": {
                    1:"Επέκταση των δικτύων φίλων μου και της εμπειρίας μου.",
                    2:"Να σκέυτομαι νέες και δημιουργικές ιδέες.",
                    3:"Να λίνω δύσκολα προβλήματα.",
    ...
    def show_final_score(self):
        ...
        if 10 <= total_score and total_score <= 15:
            self.result_label.config(text="Το συνολικό σκορ σου: {}\nΣυγχαριτήρια! Ο ρόλος σου είναι ενα μέλος\nΈνα μέλος(Member) της ομάδας έχει ως σκοπό του να κάνει την δουλεία που του δόθηκε,\n να παραβρεθεί σε κάθε συνάντηση και να προσπαθεί να βρει ιδέες και λύσεις σε ένα πρόβλημα που μπορεί να υπάρξει στη υλοποίηση της δουλείας του.\n".format(total_score))   
            team_role = "Member"
        elif 15 < total_score and total_score <= 25:
            self.result_label.config(text="Το συνολικό σκορ σου: {}\nΣυγχαριτήρια! Ο ρόλος σου είναι ο δημιουργός!\nΟι δημιουργικοί (Creative) τύποι έχουν την τάση να εγκλωβίζονται στον κόσμο της φαντασίας, της επίλυσης προβλημάτων και της σύλληψης.\n Μπορεί να μην είναι πάντα οι πιο ξεκάθαροι επικοινωνιολόγοι, διπλωμάτες ή διορθωτές, αλλά συνδυάστε τους με έναν έμπειρο σχεδιαστή και θα μπορούσαν σχεδόν να γίνουν θαύματα!\n Κάθε ομάδα επωφελείται από έναν δημιουργικό στοχαστή στην ομάδα—κάποιον που μπορεί να προσφέρει νέες ιδέες και λύσεις που αφήνουν τη δουλειά της ομάδας να ξεχωρίζει από το πλήθος.\n".format(total_score))
            team_role = "Creative"
        elif 25 < total_score and total_score <= 35:
            self.result_label.config(text="Το συνολικό σκορ σου: {}\nΣυγχαριτήρια! Ο ρόλος σου είναι ο ερευνητής!\nΟ ερευνητής (Researcher) έχει την ικανότητα να απαντά στις δικές του ερωτήσεις με την έρευνα που κάνει.\n Με αυτό καταφέρνει να έχει παραπάνω πληροφορίες για το έργο της ομάδας και είναι το άτομο που μπορεί να βασιστεί κάποιος για την επίλυση προβλημάτων και υλοποίηση δύσκολων ερωτήσεων.\n Τέλος ,έχει το φυσικό ταλέντο να ξέρει τις καλύτερες πηγές για την εύρεση πληροφοριών που συνεισφέρουν στην αντιμετώπιση του προβλήματος.\n".format(total_score))
            team_role = "Reashercher"
        else:
            self.result_label.config(text="Το συνολικό σκορ σου: {}\nΣυγχαριτήρια! Ο ρόλος σου είναι ο αρχηγός!\nO ρόλος αρχηγός(Leader) και ο ποιος σημαντικός ρόλος σε μια ομάδα, έχει ως σκοπό το προσανατολισμό της ομάδας και την αναθέτηση των κανόνων συνεργασίας των μελών.\n Ακόμη πρέπει να έχει τον έλεγχο της αναφοράς κάθε μέλους για το πως προχωρά το κομμάτι του.\n Επίσης, αναθέτει τους στόχους της ομάδας και βοηθά με την επιτύχια του κάθε μέλους για το  στόχο του και  την ομάδα για την ολοκλήρωση των στόχων που έχουν θέσει.\n Είναι και αυτός που βοηθά στην καθοδήγηση και την διαχείριση μιας ομαδικής δουλειάς για την επίτευξη των στόχων της.\n Πρέπει να είναι παρών σε όλα και συγκεντρωμένος στην ομάδα. Βοηθά επίσης στην επίλυση προβλημάτων και στο να λάβουν αποφάσεις.\n".format(total_score))
            team_role = "Leader"

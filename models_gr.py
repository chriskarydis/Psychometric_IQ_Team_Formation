...
class MainMenu(ColorConstants):
    def __init__(self,SCREEN_WIDTH,SCREEN_HEIGHT):
        ...
        self.btn_discs = []
        self.label = Button("Επέλεξε τον αριθμό των δίσκων",self.BLACK,30,'Calibri',self.WHITE,500,30)
        ...
        # Game over κουμπιά
        self.btn_play_again = Button("Παίξε ξανά",self.BLACK,30,'Calibri',self.GREEN,130,30)
        self.btn_return = Button("Μενού",self.BLACK,30,'Calibri',self.BACKGROUND,150,30)
        self.btn_quit = Button("Έξοδος",self.BLACK,30,'Calibri',self.RED,90,30)
...
class Game(ColorConstants):
    def __init__(self,SCREEN_WIDTH,SCREEN_HEIGHT):
        ...
        # Θέσεις και λίστες δίσκων
        self.positions = []
        self.discs = []
        # Σχεδιασμός του πίνακα του παιχνιδιού και της θέσης του
    ...
    # Ορισμός του αριθμού των δίσκων και των ελάχιστων κινήσεων
    def set_n_discs(self,n_discs):
        self.n_discs = n_discs
        self.min_moves = ((2**self.n_discs)-1)
    # Μέθοδος σχηματισμού δίσκων
    def draw_discs(self):
        DISC_WIDTH = 200

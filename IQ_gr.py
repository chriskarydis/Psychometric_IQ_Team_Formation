...
with open('Psychometric_IQ_Team_Formation-main\hangman_words_gr.txt', 'r', encoding='utf-8') as f:
...
class IQTestGUI:
    def __init__(self, master):
        ...
        self.questions = [
            ...
            ("Ποιός είνια ο μεγαλύτερος ωκεανός της γης;", "ΕΙΡΗΝΙΚΟΣ"),
            ...
            ("Ποιό είναι το όνομα του διάσημου επιστήμονα ο οποίος ανακάλυψε την θεωρία της σχετικότητας;", "ΑΛΜΠΕΡΤ ΑΙΝΣΤΑΙΝ"),
            ("Ποιά είναι η τετραγωνικη ρίζα του 256;", "16"),
            ("Ποιός είναι ο επόμενος αριθμός στην ακολουθία: 1, 4, 9, 16, 25, ...", "36"),
            ("Ποιά χώρα έχει τον μεγαλύτερο πλυθησμό του κόσμου;", "ΚΙΝΑ"),
